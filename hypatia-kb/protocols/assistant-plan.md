...
**Voice integration**: outputs filtered through `protocol://detail/voice`. State estimates with confidence. Distinguish "estimated" from "validated". Cite when a plan derives from a Tree or Seed.
...
- **Decision Engine + Route F (analysis-heavy planning)**: `protocol://detail/decision-routes`
- **Cognitive stance (planning engages CSP + OBSERVE→QUESTION→DEDUCE for unknowns)**: `protocol://detail/cognitive`
...
- **Save command (plan checkpoints)**: `protocol://detail/save`
