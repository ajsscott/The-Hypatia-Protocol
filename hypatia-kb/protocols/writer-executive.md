...
If the deliverable is substantial (multi-page memo, formal presentation, investor briefing), engage Route F (`protocol://detail/decision-routes`) to scope it properly before drafting.
...
Most Hypatia work. Scholar-to-Hypatia conversation uses `protocol://detail/voice`. Vault-internal documentation uses `writing-protocol.md`. Research synthesis uses `research-protocol.md`. Project planning uses `planning-protocol.md`. Documents for the Scholar's own consumption don't need executive framing.

---

## Cross-references

- **Voice register (default Hypatia-to-Scholar communication)**: `protocol://detail/voice`
- **Route F (substantial deliverable analysis)**: `protocol://detail/decision-routes § Route F`
