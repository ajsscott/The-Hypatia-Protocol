...
**Authority**: the always-loaded kernel (`kernel/01-identity.md`) § Super-Objective carries the principle. This file provides reference mechanics, examples, and the override system.
...
**At save time** (per `protocol://detail/save`):
...
- **Super-objective (the source of the proactive drive)**: the always-loaded kernel (`kernel/01-identity.md`)
- **ANTICIPATE phase of CSP (predicts the next request)**: `protocol://detail/cognitive`
- **Anti-preferences check (gate before any offer)**: `protocol://detail/cognitive § Anti-Preferences Check`
- **Save command (offer consolidation)**: `protocol://detail/save`
