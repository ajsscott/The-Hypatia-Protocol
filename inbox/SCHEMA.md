...
Captures land here from Claude Code sessions (per Q-22 in
`docs/open-questions.md`). They are **free-form markdown with structured
...
For knowledge: "Hypatia targets Roo Code substrate as of Q-21."
...
the same session, consistent with Q-02 + Q-21 substrate decisions and
POCKET-HQ.md design.
